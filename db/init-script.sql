...
CREATE TABLE workers (
    ...
    CONSTRAINT fk_workers_roles_id FOREIGN KEY (roles_id)
        REFERENCES roles (id)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_workers_teams_id FOREIGN KEY (teams_id)
        REFERENCES teams (id)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE roles_authorities (
    ...
    CONSTRAINT pk_roles_authorities PRIMARY KEY (roles_id , authorities_id),
    CONSTRAINT fk_roles_authorities_roles FOREIGN KEY (roles_id)
        REFERENCES roles (id)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_roles_authorities_authorities FOREIGN KEY (authorities_id)
