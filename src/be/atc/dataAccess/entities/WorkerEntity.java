...
public class WorkerEntity {
    ...
    private Collection<ClockingEntity> clockingsById;
    private Collection<WeeklyPlansEntity> weeklyPlansById;
    private Collection<WeeklySchedulesEntity> weeklySchedulesById;
    ...
    public Collection<ClockingEntity> getClockingsById() {
        return clockingsById;
    }

    public void setClockingsById(Collection<ClockingEntity> clockingsById) {
        this.clockingsById = clockingsById;
    }

    @OneToMany(mappedBy = "workersByWorkerId")
    public Collection<WeeklyPlansEntity> getWeeklyPlansById() {
        return weeklyPlansById;
    }

    public void setWeeklyPlansById(Collection<WeeklyPlansEntity> weeklyPlansById) {
        this.weeklyPlansById = weeklyPlansById;
    }

    @OneToMany(mappedBy = "workersByWorkerId")
    public Collection<WeeklySchedulesEntity> getWeeklySchedulesById() {
        return weeklySchedulesById;
    }

    public void setWeeklySchedulesById(Collection<WeeklySchedulesEntity> weeklySchedulesById) {
        this.weeklySchedulesById = weeklySchedulesById;
    }
}
